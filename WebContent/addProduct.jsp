				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="producttype">Loại sản phẩm</label> <select name="type"
							...
							<option value="mobile">Mechanical Watch</option>
							<option value="tv">Sports Watch</option>
							<option value="camera">Smart Watch</option>
							<option value="laptop">Fashion Watch</option>
